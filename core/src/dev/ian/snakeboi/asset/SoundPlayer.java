...
public class SoundPlayer {
    ...
    public static void init() {
        musics.put(Asset.MENU_THEME, (Music) Asset.instance().get(Asset.MENU_THEME));
        ...
        sounds.put(Asset.SELECT_SOUND, (Sound) Asset.instance().get(Asset.SELECT_SOUND));
        sounds.put(Asset.AI_ON, (Sound) Asset.instance().get(Asset.AI_ON));
        sounds.put(Asset.AI_OFF, (Sound) Asset.instance().get(Asset.AI_OFF));
    }
